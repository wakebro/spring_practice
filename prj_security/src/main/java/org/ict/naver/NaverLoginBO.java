...
public class NaverLoginBO {
	...
	// redirect_uri : callback 주소라고 입력한 곳으로, 컨트롤러에서 첫 로그인 시 DB에 계정정보를 저장하도록 처리할 주소
	// state : 애플리케이션이 생성한 상태 토큰(AOuth state로 두면 됨)
	private final static String CLIENT_ID = "비밀";
	private final static String CLIENT_SECRET = "비밀";
